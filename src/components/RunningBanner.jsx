...
export default function RunningBanner() {
  return (
    <div className="w-full h-[25px] bg-gradient-to-r from-yellow-500 to-yellow-400 flex items-center overflow-hidden relative shadow-sm z-0">
      <div className="absolute left-0 top-0 w-full h-full pointer-events-none" style={{ background: 'linear-gradient(to right, #facc15 0%, #fde047 80%, transparent 100%)' }} />
