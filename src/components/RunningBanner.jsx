...
export default function RunningBanner() {
  return (
    <div className="w-full h-[25px] bg-gradient-to-r from-green-500 to-green-400 flex items-center overflow-hidden relative shadow-sm z-0">
      <div className="absolute left-0 top-0 w-full h-full pointer-events-none" style={{ background: 'linear-gradient(to right, #22c55e 0%, #22c55e 80%, transparent 100%)' }} />
