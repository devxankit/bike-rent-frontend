...
const MumbaiTourPage = ({ cityData }) => {
  ...
  useEffect(() => {
    ...
    const fetchCities = async () => {
      try {
        ...
        setAllLocations(['Mumbai']); // Fallback
      }
    };
    fetchCities();
  }, []);
  ...
  useEffect(() => {
    const fetchTours = async () => {
      try {
        setLoading(true);
        const res = await api.get('/api/tours', { params: { isAvailable: true, location: 'Mumbai' } });
        setTours(res.data);
      } catch (err) {
    ...
    <>
      ...
      <div className="flex min-h-screen bg-gray-50">
        ...
        <main className="flex-1 overflow-y-auto">
          <div className="p-6">
            <div className="mb-6">
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Tours in Mumbai</h1>
              <p className="text-gray-600">Discover amazing tour packages in Mumbai</p>
            </div>
            ...
            {loading ? (
              ...
              <div className="text-center text-gray-500 py-8">
                <p>No tours available in Mumbai at the moment.</p>
              </div>
            ) : (
