...
const TourPrivacyPolicy = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Privacy Policy | BookYourRide Tour Services</title>
        <meta name="description" content="Learn how BookYourRide protects your privacy and handles your personal data when using our tour services. Read our comprehensive privacy policy." />
        <meta name="keywords" content="privacy policy, tour service privacy, data protection, BookYourRide privacy" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.bookyourride.in/tours/privacy-policy" />
      </Helmet>
              ...
              <div className="bg-white rounded-xl shadow-lg p-8" data-aos="fade-up">
                ...
                <div className="mb-8" data-aos="fade-up">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    At BookYourRide Tours, we are committed to protecting your privacy and ensuring the security of your personal information. 
                    This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our tour services, 
                ...
                <section id="interpretation" className="mb-8" data-aos="fade-up">
                  ...
                  <div className="space-y-4 text-gray-600">
                    <p>
                      ...
                      including but not limited to name, phone number, email address, location data, travel preferences, and payment information.
                    </p>
                    <p>
                      <strong>Service:</strong> Our tour booking and travel services provided through our platform.
                    </p>
                    <p>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <ul className="list-disc list-inside space-y-2 text-gray-600">
                        ...
                        <li><strong>Tour Booking Information:</strong> Travel dates, destinations, group size, and special requirements</li>
                        <li><strong>Payment Information:</strong> Billing address, payment method details (processed securely)</li>
                        <li><strong>Location Data:</strong> Real-time location for tour coordination and safety purposes</li>
                        <li><strong>Communication Data:</strong> Messages, calls, and feedback you provide</li>
                        <li><strong>Travel Preferences:</strong> Dietary restrictions, accessibility needs, and tour interests</li>
                      </ul>
                    </div>
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside space-y-2 text-gray-600">
                        <li>To provide and maintain our tour services</li>
                        <li>To process tour bookings and payments</li>
                        <li>To communicate with you about your tours</li>
                        <li>To customize tour experiences based on your preferences</li>
                        <li>To improve our services and customer experience</li>
                        <li>To ensure safety and security during tours</li>
                ...
                <section id="contact" className="mb-8" data-aos="fade-up">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <p className="text-gray-700"><strong>Email:</strong> privacy@tourrent.com</p>
