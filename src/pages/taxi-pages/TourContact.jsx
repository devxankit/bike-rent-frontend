      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-xl p-6" data-aos="fade-up" data-aos-delay="500">
              ...
              <div className="bg-gray-50 rounded-xl p-6" data-aos="fade-up" data-aos-delay="600">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
              {[
                ...
                <div key={destination} className="bg-white p-4 rounded-lg text-center shadow-sm hover:shadow-md transition-shadow" data-aos="fade-up" data-aos-delay={index * 50}>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-gray-50 rounded-xl p-8" data-aos="fade-up" data-aos-delay="200">
