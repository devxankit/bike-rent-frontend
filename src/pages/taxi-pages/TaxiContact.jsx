        ...
        <section className="py-12 md:py-16 bg-gray-50">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 text-center" data-aos="fade-up">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
              {taxiCities.length > 0 ? (
                taxiCities.map((city, index) => (
                  <div key={city._id || city.slug || city.name} className="bg-white p-4 rounded-lg text-center shadow-sm hover:shadow-md transition-shadow" data-aos="fade-up" >
