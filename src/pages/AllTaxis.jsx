          ...
          <Box sx={{ flex: 1 }}>
            {navItems.map((item, idx) => {
              ...
              if (item.label === 'Bookings') {
                isActive = location.pathname === '/admin/taxis' && new URLSearchParams(location.search).get('tab') === '1';
              } else if (item.label === 'Taxis') {
                isActive = location.pathname === '/admin/taxis' && (!new URLSearchParams(location.search).get('tab') || new URLSearchParams(location.search).get('tab') === '0');
              } else if (item.label === 'Bikes') {
                isActive = location.pathname === '/admin/bikes';
              ...
              return (
                <Box
                  ...
                  onClick={() => {
                    if (item.label === 'Bookings') navigate('/admin/taxis?tab=1');
